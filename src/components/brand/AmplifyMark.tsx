...
/**
 * The Amplify HQ mark — a stylized head-in-profile with a brain and
 * signal waves radiating out. Psychology + business, in one shape.
 */
export function AmplifyMark({
  ...
  const markBrain =
    tone === "light" ? "#f26b4f" : tone === "signal" ? "#ffffff" : "#f26b4f";
