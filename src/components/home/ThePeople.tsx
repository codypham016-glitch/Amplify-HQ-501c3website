...
/**
 * The people Amplify brings into the room. Typography-forward — the
 * roles read as one flowing statement, coral separators as a signal.
 */
  ...
  return (
    <section className="bg-[color:var(--color-lavender-tint)] py-24 lg:py-32">
      <Container>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-8">
            ...
            <p className="mt-10 max-w-2xl text-lg leading-[1.65] text-[color:var(--color-navy-2)]">
              People with actual answers to the questions students are trying to ask. Speaker sessions are small enough that a student can ask a real question — the kind you can&apos;t ask in front of two hundred people — and get a real answer.
            </p>
        ...
        <div className="mt-16 text-[color:var(--color-navy)]/40">
          <SignalDivider variant="line" color="currentColor" height={40} />
        </div>
      </Container>
    </section>
  );
